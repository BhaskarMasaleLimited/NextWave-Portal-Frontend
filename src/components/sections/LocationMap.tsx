  ...
  return (
    <section id="location" className="py-20 lg:py-28 bg-white section-padding">
      <div className="section-container">
        ...
        >
          {/* Factory 1 Location */}
          <div className="bg-white border border-black/5 rounded-2xl overflow-hidden shadow-md shadow-black/5 hover:shadow-xl transition-all duration-500 flex flex-col">
            <div className="p-6 pb-5 flex items-start justify-between">
              ...
              <a 
                ...
                className="text-primary hover:text-accent text-sm font-semibold flex items-center gap-1.5 transition-colors duration-300 bg-cream-dark px-3.5 py-1.5 rounded-full shadow-sm"
